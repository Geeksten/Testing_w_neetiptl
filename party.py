...
def most_and_least_common_type(treats):
    """Given list of treats, return {most, least} common types.
        ...
        >>> most_and_least_common_type([{'type': 'dessert','description': 'Chocolate mousse','who': 'Heather'},
        ... {'type': 'dessert','description': 'Cardamom-Pear pie','who': 'Joel'},
        ... {'type': 'appetizer','description': 'Humboldt Fog cheese','who': 'Meggie'}])
        ('dessert','appetizer')
